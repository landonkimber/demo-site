...
const NavBar = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 flex justify-center content-center bg-gradient-to-br from-slate-700 to-sky-950 bg-opacity-50 h-32 shadow-md select-none z-15">
